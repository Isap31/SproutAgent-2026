...
Widget Interface
StateBehaviorIdleDisplays current AI skill level and a contextual tipActiveSurfaces a real-time AI recommendationCoachingDelivers step-by-step guidance for the current taskQuick ActionExecutes a suggested AI task in a single tap

Target Users
SegmentProblem BridgeAI SolvesCollege studentsAI tools exist — practical instruction does notYoung professionalsPeers are leveraging AI; they are falling behindSmall business ownersNo budget for AI consulting; need on-demand expertiseCareer changersMust upskill rapidly without access to formal programsGeneral adultsUnderstand AI matters; lack a clear starting point
